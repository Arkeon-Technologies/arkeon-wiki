...
| `label_contains` | — | Case-insensitive substring match on `label`. "Baker Street" matches "221B Baker Street". `label_prefix` is accepted as a legacy alias for the same query. |
