...
const INGESTOR_GATHER_PROMPT = [
  ...
  "   Read the top hits' labels and chunk text. A vector hit with",
  "   similarity ≳ 0.6 to a wiki whose subject is plausibly the same as",
  "   yours is a match — even if the labels differ. Treat it as [EXISTS]",
  "   and read_file the matching wiki.",
  "",
  ...
  "",
  "4. For subjects you've identified as [EXISTS] via either path,",
  "   read_file the matching wiki so phase 2 sees its current shape and",
  "   prior citations.",
  "",
