...
const OPERATIONS: GeneratedOperation[] = [
  ...
  },
  {
    ...
    auth: "optional",
    pathParams: [],
    queryParams: [{ name: "filter", description: "Column/property filters. See GET /help for filter syntax.", required: false, type: "string" }, { name: "sort", description: "updated_at | created_at (default: updated_at)", required: false, type: "string", enumValues: ["updated_at","created_at"] }, { name: "order", description: "asc | desc (default: desc)", required: false, type: "string", enumValues: ["asc","desc"] }, { name: "view", description: "Projection: summary | expanded | page. Default returns all fields. expanded adds _relationships. page returns structured links_to/linked_from/sources.", required: false, type: "string", enumValues: ["summary","expanded","page"] }, { name: "fields", description: "Comma-separated field list", required: false, type: "string" }, { name: "limit", description: "Max results (default 50, max 200)", required: false, type: "integer" }, { name: "cursor", description: "Pagination cursor", required: false, type: "string" }, { name: "space_id", description: "Scope results to a space ULID", required: false, type: "string" }],
    bodyFields: [],
  },
  {
