...
const OPERATIONS: GeneratedOperation[] = [
  ...
  },
  {
    ...
    description: "Live status of all background worker queues (extract, draft, enrich)",
    auth: "required",
    pathParams: [],
  ...
  },
  {
    ...
    description: "Delete a space and its orphaned entities",
    auth: "required",
    pathParams: [{ name: "id", description: "Space ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    action: "delete-focus",
    method: "DELETE",
    path: "/spaces/{id}/focus",
    summary: "Clear all extraction focus prompts for a space",
    description: "Clear all extraction focus prompts for a space",
    auth: "required",
    pathParams: [{ name: "id", description: "Space ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  ...
  },
  {
    ...
    pathParams: [{ name: "id", description: "Space ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [{ name: "draft", description: "Focus prompt for the draft worker — guides how wiki articles are written", required: false, type: "string" }, { name: "extract", description: "Focus prompt for the extract worker — guides what subjects to extract from documents", required: false, type: "string" }],
  },
  {
  ...
  },
  {
    ...
    description: "Get extraction focus prompts for a space",
    auth: "optional",
    pathParams: [{ name: "id", description: "Space ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  ...
  },
  {
    ...
    group: "wiki",
    action: "create-placeholders",
    method: "POST",
    path: "/wiki/placeholders",
    summary: "Create placeholder entities for subjects to be drafted",
    description: "Create placeholder entities for subjects to be drafted",
    auth: "required",
    pathParams: [],
    queryParams: [],
    bodyFields: [{ name: "enqueue_draft", description: "If true, enqueue each placeholder for wiki drafting in the same transaction (default false)", required: false, type: "boolean" }, { name: "placeholders", description: "Placeholders to create", required: true, type: "array" }, { name: "space_id", description: "Space to add placeholders to", required: true, type: "string" }],
  },
  {
    ...
    method: "POST",
    path: "/wiki/{id}/redirect",
    summary: "Create a redirect from one entity to another",
    description: "Create a redirect from one entity to another",
    auth: "required",
    pathParams: [{ name: "id", description: "Source entity ULID (the entity being redirected)", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [{ name: "target_id", description: "Target entity ULID to redirect to", required: true, type: "string" }],
  },
  {
  ...
  },
  {
    ...
    description: "Enqueue enrichment of a wiki from a source document",
    auth: "required",
    pathParams: [{ name: "id", description: "Wiki entity ULID to enrich", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [{ name: "source_id", description: "Source file entity ULID to enrich from", required: true, type: "string" }],
  },
  {
